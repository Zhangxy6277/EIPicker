...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    if dataset == 'coco_hp':
      ...
      self.names = E10057_class_names
    elif num_classes == 20 or dataset == 'pascal':
      self.names = pascal_class_name
    elif dataset == 'proteasome_512':
      self.names = proteasome_512_class_name
    elif dataset == 'GspDvc_1024':
      self.names = GspDvc_class_names
    elif dataset == 'particle':
      self.names = particle_class_names
    elif dataset == 'TrpV1_1024':
      self.names = TrpV1_class_names
    elif dataset == 'TandP':
      self.names = TandP_class_names
    elif dataset == 'Pand10017':
      self.names = Pand10017_class_name
    elif dataset == 'Pand17and89and57':
      self.names = Pand17and89and57_class_names
    elif dataset == 'Tand10017':
      self.names = Tand10017_class_name
    elif dataset == 'EMPIAR-10017':
      self.names = EMPIAR_class_names
    elif dataset == 'E10089':
      self.names = E10089_class_names
    elif dataset == 'E10058':
      self.names = E10058_class_names
    elif dataset == 'Pand10089':
      self.names = Pand10089_class_names
    elif dataset == 'gta':
...
Pand10017_class_name = [
  'Pand10017'
]
Tand10017_class_name = [
  'Tand10017'
]
...
Pand17and89and57_class_names = [
  'Pand17and89and57'
]
Pand10089_class_names = [
  'Pand10089'
]
