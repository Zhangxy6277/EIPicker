...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--data', default='../data/EMPIAR_10017',
                             help='the path of training data')
    self.parser.add_argument('--label_type', default='star',
                             help='star | box | coord | thi')
    self.parser.add_argument('--data_type', default='png')
    self.parser.add_argument('--sample_number', default=500,type=int)
    self.parser.add_argument('--particle_size', default=4.75, type=float)
    self.parser.add_argument('--task', default='ctdet',
                             help='ctdet | ddd | multi_pose | exdet')
    self.parser.add_argument('--dataset', default='particle',
                             help='EMPIAR-10017 | E10089 | Pand17and89and57 | E10057|Pand10089|E10058|all6'
                              '| proteasome | proteasome_512 | GspDvc_1024 | TrpV1_1024|TandP|Pand10017|Tand10017')
  ...
  def parse(self, args=''):
    ...
    opt.save_dir = os.path.join('./', opt.exp_id)
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [1024, 1024], 'num_classes': 1,
                'mean': [0.502256,0.502256,0.502256], 'std': [0.289417,0.289417,0.289417],
                'dataset': 'proteasome'},
      ...
      'multi_pose': {
        ...
        'mean': [0.502, 0.502, 0.502], 'std': [0.289, 0.274, 0.278],
