...
class Pand10017(data.Dataset):
  num_classes = 1
  default_resolution = [1024, 1024]
  mean = np.array([ 0.700788,0.700788,0.700788],
                   dtype=np.float32).reshape(1, 1, 3)
  std  = np.array([0.408061,0.408061,0.408061],
                   dtype=np.float32).reshape(1, 1, 3)

  def __init__(self, opt, split):
    super(Pand10017, self).__init__()
    self.data_dir = os.path.join(opt.data_dir, 'Pand10017')
