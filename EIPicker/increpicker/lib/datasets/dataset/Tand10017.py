...
class Tand10017(data.Dataset):
  num_classes = 1
  default_resolution = [1024, 1024]
  mean = np.array([ 0.506271,0.506271,0.506271],
                   dtype=np.float32).reshape(1, 1, 3)
  std  = np.array([0.178633,0.178633,0.178633],
                   dtype=np.float32).reshape(1, 1, 3)

  def __init__(self, opt, split):
    super(Tand10017, self).__init__()
    self.data_dir = os.path.join(opt.data_dir, 'Tand10017')
