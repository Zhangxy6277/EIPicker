...
class EMPIAR_10017(data.Dataset):
  num_classes = 1
  default_resolution = [1024, 1024]
  mean = np.array([0.510138, 0.510138, 0.510138],
                   dtype=np.float32).reshape(1, 1, 3)
  std  = np.array([0.288824, 0.288824, 0.288824],
                   dtype=np.float32).reshape(1, 1, 3)

  def __init__(self, opt, split):
    super(EMPIAR_10017, self).__init__()
    self.data_dir = os.path.join(opt.data_dir, 'EMPIAR_10017')
  ...
  def bbox_valid(self, bbox, imsize=1024, dis=30):
