...
class Pand17and89and57(data.Dataset):
  num_classes = 1
  ...
  def __init__(self, opt, split):
    super(Pand17and89and57, self).__init__()
    self.data_dir = os.path.join(opt.data_dir, 'Pand17and89and57')
    ...
    self.max_objs = 1500
    self.class_name = [
      '__background__', 'Pand17and89and57']
    self._valid_ids = [
      1]
    ...
    print('==> initializing Pand17and89and57 {} data.'.format(split))
