...
class E10057(data.Dataset):
    num_classes = 1
    default_resolution = [1024, 1024]
    mean = np.array([0.511278, 0.511278, 0.511278],
                    dtype=np.float32).reshape(1, 1, 3)
    std = np.array([0.203795,0.203795, 0.203795],
                   dtype=np.float32).reshape(1, 1, 3)

    def __init__(self, opt, split):
        super(E10057, self).__init__()
        self.data_dir = os.path.join(opt.data_dir, '10057')
